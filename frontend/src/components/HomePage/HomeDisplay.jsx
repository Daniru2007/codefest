  ...
  return (
    <div className="home-display">
      ...
      <div className="home-display__benefits">
        ...
        <div className="home-display__benefits__content">
          <h1>Why Should You Join Us?</h1>
          <p>
            By using the resources and tools provided on the website, students
            can learn how to better manage their time and prioritize their
            tasks, leading to increased productivity and success in their
            studies.By using the resources and tools provided on the website,
            students can learn how to better manage their time and prioritize
            their tasks, leading to increased productivity and success in their
            studies.
          </p>
        </div>
      </div>
